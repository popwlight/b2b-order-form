...
\<img
src="[https://www.capezio.au/static/version1745830218/frontend/Aws/capezio/en\_AU/images/logo.svg](https://www.capezio.au/static/version1745830218/frontend/Aws/capezio/en_AU/images/logo.svg)"
alt="Logo"
style={{ height: 30.645, marginRight: 10 }}
/>
\<h1 style={{ fontSize: 20 }}>Capezio Summer 2026 Order Form</h1> </div>
\<div style={{ marginBottom: 10 }}> <label><b>Choose Secion:</b> </label>
\<select
value={sheetName}
onChange={(e) => {
